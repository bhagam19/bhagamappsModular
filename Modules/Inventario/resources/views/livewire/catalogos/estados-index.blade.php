<div>
    ...
    <div class="row align-items-center mb-3">
        ...
        <div class="col-md-4 mb-2 mb-md-0">
            <input wire:model.live.debounce.300ms="busqueda" type="text"
                class="form-control form-control-sm" placeholder="Buscar estado...">
        </div>
    ...
    <div class="card card-body bg-light mb-3">
        <h6 class="font-weight-bold mb-3">Nuevo Estado de Bien</h6>
        <div class="form-group mb-2">
            ...
            <input wire:model.lazy="nuevoNombre" type="text"
                ...
                placeholder="Nombre del estado" autofocus>
    ...
    <div class="table-responsive">
        <table class="table table-sm table-bordered table-hover">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center text-muted py-3">No se encontraron estados.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
