<div>
    ...
    <div class="row align-items-center mb-3">
        <div class="col-md-4 mb-2 mb-md-0">
            @can('crear-almacenamientos')
            <button wire:click="iniciarCreacion" class="btn btn-success btn-sm">
                <i class="fas fa-plus mr-1"></i> Nuevo Almacenamiento
            </button>
            @endcan
        </div>
        <div class="col-md-4 mb-2 mb-md-0">
            <input wire:model.live.debounce.300ms="busqueda" type="text"
                class="form-control form-control-sm" placeholder="Buscar almacenamiento...">
        </div>
    ...
    <div class="card card-body bg-light mb-3">
        <h6 class="font-weight-bold mb-3">Nuevo Almacenamiento</h6>
        <div class="form-group mb-2">
            ...
            <input wire:model.lazy="nuevoNombre" type="text"
                ...
                placeholder="Nombre del almacenamiento" autofocus>
        ...
        <table class="table table-sm table-bordered table-hover">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th style="width:100px" class="text-center">Bienes</th>
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center text-muted py-3">No se encontraron almacenamientos.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
