<div>
    ...
    <div class="row align-items-center mb-3">
        ...
        <div class="col-md-4 mb-2 mb-md-0">
            <input wire:model.live.debounce.300ms="busqueda" type="text"
                class="form-control form-control-sm" placeholder="Buscar categoría...">
        </div>
    ...
    <div class="card card-body bg-light mb-3">
        <h6 class="font-weight-bold mb-3">Nueva Categoría</h6>
        <div class="form-group mb-2">
            <label class="small font-weight-bold">Nombre <span class="text-danger">*</span></label>
            <input wire:model.lazy="nuevoNombre" type="text" class="form-control form-control-sm @error('nuevoNombre') is-invalid @enderror"
