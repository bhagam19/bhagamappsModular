<div>
    ...
    <div class="row align-items-center mb-3">
        ...
        <div class="col-md-4 mb-2 mb-md-0">
            <input wire:model.live.debounce.300ms="busqueda" type="text"
                class="form-control form-control-sm" placeholder="Buscar ubicación...">
        </div>
    ...
    <div class="card card-body bg-light mb-3">
        <h6 class="font-weight-bold mb-3">Nueva Ubicación</h6>
        <div class="form-group mb-2">
            ...
            <input wire:model.lazy="nuevoNombre" type="text"
                ...
                placeholder="Nombre de la ubicación" autofocus>
        ...
        <table class="table table-sm table-bordered table-hover">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th style="width:120px" class="text-center">Dependencias</th>
            ...
            <tbody>
                @forelse($items as $item)
                    ...
                    <tr class="bg-warning">
                        ...
                        <td class="text-center align-middle">{{ $item->dependencias_count }}</td>
                    ...
                    <tr>
                        ...
                        <td class="text-center align-middle">
                            <span class="badge badge-{{ $item->dependencias_count > 0 ? 'info' : 'secondary' }}">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center text-muted py-3">No se encontraron ubicaciones.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
