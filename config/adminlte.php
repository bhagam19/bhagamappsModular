...
return [
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/aIcon.png',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'active'  => ['admin/backups', 'admin/backups/*'],
                    'classes' => 'font-weight-bold',
                ],
                [
                    'text'    => 'Restaurar',
                    'icon'    => 'fas fa-undo-alt text-warning',
                    'route'   => 'admin.backups.restaurar',
                    'active'  => ['admin/backups/restaurar'],
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'route'  => 'inventario.catalogos.categorias',
                    'active' => ['inventario/catalogos/categorias*'],
                    'can'    => 'ver-categorias',
                ],
                [
                    'text'   => 'Dependencias',
                    'icon'   => 'fas fa-sitemap text-info',
                    'route'  => 'inventario.catalogos.dependencias',
                    'active' => ['inventario/catalogos/dependencias*'],
                ...
                [
                    ...
                    'icon'   => 'fas fa-trash-alt text-info',
                    'route'  => 'inventario.heb',
