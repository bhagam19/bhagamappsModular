<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center gap-3">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Asignar responsable</h2>
        </div>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow sm:rounded-lg overflow-hidden">
                ...
                <form method="POST" action="{{ route('inventario.bienes.responsable.store', $bien) }}" class="px-6 py-6 space-y-5">
                    @csrf
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Fecha de asignación <span class="text-red-500">*</span></label>
                        <input type="date" name="fecha_asignacion" value="{{ old('fecha_asignacion', now()->toDateString()) }}" required
